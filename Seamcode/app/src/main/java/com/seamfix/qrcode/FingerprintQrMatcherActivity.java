...
public class FingerprintQrMatcherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Data qrData = FingerQrCode.getDecodeQrData(templateData);
        if(qrData!= null){
    ...
    SingleFingerCaptureView.SingleCaptureListener listener = new SingleFingerCaptureView.SingleCaptureListener() {
        ...
        public void onSingleCaptureFinished(FingerPrintCaptureResult result) {
            ...
            if(decodedIsoTemplate != null) {
                ...
                Toast.makeText(FingerprintQrMatcherActivity.this, "Match found: "+ isMatch, Toast.LENGTH_SHORT).show();
                if(isMatch){
                    matchFoundDialog();
                }else{
                    matchNotFoundDialog();
            ...
            Toast.makeText(FingerprintQrMatcherActivity.this, "Process was not successful", Toast.LENGTH_SHORT).show();
        }
