...
public class FingerVerificationDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finger_verification_details);
        ...
        next           = findViewById(R.id.id_ok_finish);
